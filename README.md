/**
    ...
    Permite que los usuarios hagan clic en un elemento de la lista y los redirija a la página de perfil del usuario correspondiente. Pasa el ID del usuario como parámetro a través de la ruta.

    - Recibir y utilizar parámetros

    En la página del perfil del usuario, recibe el parámetro pasado por la ruta.
    Utiliza ese parámetro para cargar la información específica del usuario desde una fuente de datos (puede ser un array en el propio componente por simplicidad).
